<?php
    ...
    class SettingController extends Controller
    {
        public function index() {
			...
			$colors["general"][1] = ["name" => "Podrzędny", "color" => isset($data["color"]["general"][1]["color"]) ? $data["color"]["general"][1]["color"] : "#cccccc", "disabled" => true];
			$colors["general"][2] = ["name" => "Kolor tesktu", "color" => isset($data["color"]["general"][2]["color"]) ? $data["color"]["general"][2]["color"] : "#cccccc", "disabled" => true];
			$colors["general"][3] = ["name" => "Akcent", "color" => isset($data["color"]["general"][3]["color"]) ? $data["color"]["general"][3]["color"] : "#cccccc", "disabled" => true];
			$colors["link"] = [];
