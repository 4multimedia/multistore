class NodeService {
     ...
     handleCanvasDrop(cursor) {
       ...
       const curentComponent = draggedNode.props.component;
       const parentComponent = currentNode.parent === null ? null : currentNode.props.component;

       if (curentComponent == 'Column' && parentComponent != 'Row') {
        //alert('Kolumnę mozna tylko dodac do Row');
        //return;
       }
